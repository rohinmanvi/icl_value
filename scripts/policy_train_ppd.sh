...
#SBATCH --output=/home/rohin/icl_value/logs/policy_ppd.out
#SBATCH --error=/home/rohin/icl_value/logs/policy_ppd.err
...
output_dir="models/policy_ppd_qwen17b_tau01"
...
python3 -u src/train_policy_ppd.py \
  ...
  --gradient-checkpointing 2>&1 | tee -a /home/rohin/icl_value/logs/policy_ppd_$(basename ${output_dir}).log

...
#SBATCH --job-name=train_policy_adv
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=1
#SBATCH --gpus-per-node=8
#SBATCH --cpus-per-gpu=12
#SBATCH --output=/home/rohin/icl_value/logs/train_policy_adv.out
#SBATCH --error=/home/rohin/icl_value/logs/train_policy_adv.err
...
echo "Starting policy advantage-weighted training:"
echo "  Model:       $model_id"
echo "  Data:        $data_path"
...
python3 -u src/train_policy_adv.py \
    --model_id "$model_id" \
    --data_path "$data_path" \
    ...
    --max_steps $max_steps \
    --log_freq $log_freq \
    --gradient_checkpointing 2>&1 | tee -a /home/rohin/icl_value/logs/train_policy_adv_$(basename ${weights_path}).log
